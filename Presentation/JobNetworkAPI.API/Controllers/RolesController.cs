...
using JobNetworkAPI.Application.Features.Commands.Role.CreateRole;
using JobNetworkAPI.Application.Features.Commands.Role.DeleteRole;
using JobNetworkAPI.Application.Features.Commands.Role.UpdateRole;
using JobNetworkAPI.Application.Features.Queries.Role.GetRoleById;
using JobNetworkAPI.Application.Features.Queries.Role.GetRoles;
using MediatR;
...
namespace JobNetworkAPI.API.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        [HttpPost()]
        [AuthorizeDefinition(ActionType = Application.Enums.ActionType.Writing, Definition = "Create Roles", Menu = "Roles")]
